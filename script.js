...
const feedbackMessages = {
  part01: {
    ...
    a1b2: "<h2>Feedback</h2><p><span class='left'>Excellent decision to review the work request.</span><br /><br /><span class='left'>Remember that you should conduct a visual inspection as well as calculate the MEL before processing the device.</span></p>",
    a1b3: "<h2>Feedback</h2><p><span class='left'>Great decision to review the work request in GCSS-A.</span><br /><br /><span class='left'>Remember that you should calculate the MEL and conduct a visual inspection before procesing the device for repair.</span><br /><br /><span class='left'>By skipping these steps, you could have issues down the line when getting the repair paid for, as well as missing documentation.</span></p>",
    a2: "<h2>Feedback</h2><p><span class='left'>Hold your horses.</span><br /><br /><span class='left'>Remember to follow the process because, if you send the device off without completing a visual inspection or determining the MEL, you could cost your unit and the Army a lot of money down the line.</span></p>",
    a3b1: "<h2>Feedback</h2><p><span class='left'>These are both excellent decisions.</span><br /><br /><span class='left'>However, if you don't review the work request in GCSS-A first, this can cause issues with the documentation of the work order.</span></p>",
    a3b2: "<h2>Feedback</h2><p><span class='left'>It is important to conduct the visual inspection and the MEL. You may not necessarily need DA form 2404 if you have access to GCSS-A.</span><br /><br /><span class='left'>By not reviewing the work request first in GCSS-A, there could be problems down the line with the documentation of the repair.</span></p>",
    a3b3: "<h2>Feedback</h2><p><span class='left'>It is important to conduct a visual inspection of the device, however, before you send the device off for repair, remember to review the work request in GCSS-A.</span><br /><br /><span class='left'>By not having a look at the work order it could cause issues down the line when documenting the repair.</span></p>",
  },
  part02: {
    a1b1: "<h2>Feedback</h2><p><span class='left'>Excellent decision to document the device.</span><br /><br /><span class='left'>However, before you approve the release of the device, you must conduct a function check.</span><br /><br /><span class='left'>Also, remember that every part of the work request should be entered in GCSS-A.</span></p>",
    a1b3: "<h2>Feedback</h2><p><span class='left'>Wait just a second.</span><br /><br /><span class='left'>It is great that you were able to document the device in GCSS-A, however, remember that you should conduct a function check before releasing the device.</span><br /><br /><span class='left'>This is important to do because there could still be potential issues with the device that could cost lives.</span></p>",
    a1b4: "<h2>Feedback</h2><p><span class='left'>Excellent decision to document the device and return it back to the customer after conducting a function check.</span><br /><br /><span class='left'>Also, remember that every part of the work request should be entered in GCSS-A.</span></p>",
    a2b1: "<h2>Feedback</h2><p><span class='left'>Great call to enter the paperwork in GCSS-A and to send the device off for repair.</span><br /><br /><span class='left'>Don't forget to conduct a function check before releasing the device back to the customer.</span><br /><br /><span class='left'>Without conducting the function check, you could potentially send back a device that is not functioning correctly, which could malfunction while in the field (and cost a life!).</span></p>",
    a2b3: "<h2>Feedback</h2><p><span class='left'>Great call to enter the paperwork into GCSS-A and to send the device off for repair.</span><br /><br /><span class='left'>Remember to conduct a function check before releasing the device back to the customer.</span></p>",
    a2b4: "<h2>Feedback</h2><p><span class='left'>Great call to enter the paperwork in GCSS-A and to send the device off for repair.</span><br /><br /><span class='left'>Fantastic choice to conduct a function check using the manufacturer's manual.</span></p>",
    a3: "<h2>Feedback</h2><p><span class='left'>If you send the device immediately off for repair without ensuring that the paperwork is entered in GCSS-A, you could have issues when the device is returned for not following the SOP.</span><br /><br /><span class='left'>Remember that you manage the repair process and not necessarily conducting the repair.</span></p>",
  },
  part03: {
